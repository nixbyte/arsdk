...
import pro.gid.sdk.common.helpers.SnackbarHelper
import pro.gid.sdk.common.helpers.TapHelper

/** Contains UI elements for Hello AR. */
class HelloArView(val activity: LahtaActivity) : DefaultLifecycleObserver {
